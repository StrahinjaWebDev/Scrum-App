      ...
      <div className="container mx-auto ">
        <div className="-mx-4 flex flex-wrap ">
          <div className="w-full px-4 ">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px] bg-gradient-to-r to-red-300 from-sky-300">
              <div className="mb-10 text-center md:mb-16">
                <h1 className="text-5xl font-extrabold text-gray-900">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r to-red-500 from-sky-700">
                    Scrum Board
                  </span>
                </h1>
              </div>
              <p className="mb-6 text-base text-gray-500 font-semibold">
                Connect With
              </p>
